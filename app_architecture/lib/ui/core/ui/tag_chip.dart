...
/// A customizable chip widget that displays a tag with an icon
class TagChip extends StatelessWidget {
  ...
  /// Font size for the tag text and icon
  final double fontSize;
  
  /// Height of the chip widget
  final double height;
  
  /// Background color of the chip
  final Color? chipColor;
  
  /// Text and icon color of the chip
          ...
          child: SizedBox(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  // Icon representing the tag category
                  Icon(
                    _iconFrom(tag),
                    color: onChipColor ??
  ...
  /// Maps tag names to their corresponding icons
  IconData? _iconFrom(String tagName) {
  ...
  /// Creates the text style for the tag
  /// Note: Original Figma design uses Google Sans font,
  /// but we use Open Sans as it's available on GoogleFonts
...
/// Theme extension for TagChip styling
